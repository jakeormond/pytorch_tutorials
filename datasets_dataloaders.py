...
# torch.utils.data.Dataset and implement functions specific to the particular data. They can be used to 
# prototype and benchmark your model. You can find them here: Image Datasets, Text Datasets, and Audio Datasets

# Loading a Dataset
# Here is an example of how to load the Fashion-MNIST dataset from TorchVision. Fashion-MNIST is a dataset of 
...
# we typically want to pass samples in “minibatches”, reshuffle the data at every epoch to reduce model 
...
# batches the data is shuffled (for finer-grained control over the data loading order, take a look at Samplers).
