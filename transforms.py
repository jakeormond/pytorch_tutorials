...
# Lambda Transforms
# Lambda transforms apply any user-defined lambda function. Here, we define a function to 
# turn the integer into a one-hot encoded tensor. It first creates a zero tensor of size 10 
